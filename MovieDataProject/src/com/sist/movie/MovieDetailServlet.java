...
public class MovieDetailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// 화면 출력
		response.setContentType("text/html;charset=UTF-8");  // 원시 소스
		// JSP <%@ page contentType="text/html;charset=UTF-8"%>
		// HTML을 출력할 위치 확인
		PrintWriter out=response.getWriter();
		// JSP에서는 내장객체(미리 생성) => <% out.println("<html>") %>
		// 오라클 출력을 위한 사용자가 보내준 데이터 읽기
		// "MovieDetailServlet?mno=5"  ==>  NumberFormatException 오류
		String mno=request.getParameter("mno");   // 필요시 반드시 변환
		/*
		 *    Wrapper
		...
		out.println("<table class=\"table\">");   // 아무것도 없는 것
		out.println("<tr>");
		out.println("<td class=text-center>");
		out.println("<embed src=\"http://youtube.com/embed/"+vo.getKey()+"\" width=960 height=350>");
		out.println("</td>");
		out.println("</tr>");
		out.println("</table>");
		...
		out.println("</tr>");
		out.println("<tr>");
		out.println("<th width=15% class=\"text-right danger\">개봉</th>");
		 ...
		 *      개봉	2021.01.27
		    ...
		    */
		out.println("<tr>");
		out.println("<th width=15% class=\"text-right danger\">장르</th>");
		out.println("<td width=60%>");
		...
		out.println("<tr>");
		out.println("<th width=15% class=\"text-right danger\">국가</th>");
		out.println("<td width=60%>");
		...
		out.println("<tr>");
		out.println("<th width=15% class=\"text-right danger\">등급</th>");
		out.println("<td width=60%>");
		...
		out.println("<tr>");
		out.println("<th width=15% class=\"text-right danger\">러닝타임</th>");
		out.println("<td width=60%>");
		...
		out.println("<tr>");
		out.println("<th width=15% class=\"text-right danger\">평점</th>");
		out.println("<td width=60%>");
		...
		out.println("<tr>");
		out.println("<th width=15% class=\"text-right danger\">누적관객</th>");
		out.println("<td width=60%>");
		...
		out.println("<tr>");
		out.println("<th width=15% class=\"text-right danger\">박스오피스</th>");
		out.println("<td width=60%>");
