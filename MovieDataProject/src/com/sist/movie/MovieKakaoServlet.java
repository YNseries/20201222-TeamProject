...
@WebServlet("/MovieKakaoServlet")
public class MovieKakaoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1 class=text-center>카카오페이지</h1>");
		out.println("<div class=row>");
		out.println("<div class=text-right>");
		out.println("<a href=MovieMainServlet?mode=4 class=\"btn btn-lg btn-success\">종료예정</a>");
		out.println("<a href=MovieMainServlet?mode=4&cno=11 class=\"btn btn-lg btn-info\">공개예정</a>");
		out.println("</div>");
		out.println("</div>");
		out.println("<div class=row>");
		for(MovieVO vo:list)
