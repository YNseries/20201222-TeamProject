...
/*
 *    Wrapper: 기본 데이터형을 클래스화 시킨 클래스들의 집합
 *    =======
 *      정수형
 *        byte    ============ Byte
 *        short   ============ Short
 *        int     ============ Integer *****
 *                               변환) 문자열 => 정수: parseInt("문자열")
 *                                    => 에러(정수변환이 안될 때 NumberFormatException)
...
public class MainClass2 {
	...
	public static void main(String[] args) {
		...
		String s1=scan.next();
		int i=Integer.parseInt(s1.trim());  // 공백문자 제거 후 정수형으로 변환
		...
		int i=100;
		Integer ii=i;  // 오토박싱(일반 정수형처럼 쓰이는 것)
		int j=ii;      // 언박싱
		// 일반데이터형 <=> 클래스형
		//        호환이 됨
		Boolean boo=true;
		...
		int k2=Integer.parseInt("1000");  // 10진법 => 1000
		int k3=Integer.parseInt("100",8);	// 64
		/*
		 *     1   0   0
		 *    8^2 8^1 8^0
		 */
		int k4=Integer.parseInt("FF",16);  // 16진법 F=>15
		...
		Long k8=10L;  // Long 클래스 안에는 반드시 long만 사용할 수 있다
	}
